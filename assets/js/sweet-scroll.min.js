...
!(function (t, e) {
  ...
  var t = function () {
    ...
    o = (function () {
      ...
      try {
        ...
        n.addEventListener("test", null, o),
          n.removeEventListener("test", null, o);
      } catch (t) {}
      return t;
    })(),
    i = function (t) {
    ...
    M = function (t) {
      return { width: $(t), height: O(t) };
    },
    E = { y: "scrollTop", x: "scrollLeft" },
    I = { y: "pageYOffset", x: "pageXOffset" },
    C = function (t, e) {
    ...
    W = function (e, n) {
      ...
      else if (!u((o = e)) && o - parseFloat(o) + 1 >= 0)
        n ? (r.top = e) : (r.left = e);
      else {
        if (!i(e)) return null;
  ...
  return (function () {
    function o(n, i) {
      ...
      (this.$el = null),
        ...
        (this.loop = function (t) {
          ...
          if ((i.start || (i.start = t), i.progress && n)) {
            ...
            Object.keys(a).forEach(function (t) {
              ...
              h <= f
                ? (r.hook(u, "step", d), (i.id = o.raf(r.loop)))
                : r.stop(!0);
          } else r.stop();
        }),
          ...
          for (
            ...
            if (b(o, n.trigger)) {
              ...
              l && e.preventDefault(),
                s && e.stopPropagation(),
                (r.ctx.$trigger = o),
                f && c ? r.to(u, a) : c ? r.toTop(u, a) : f && r.toLeft(u, a);
              break;
            }
        }),
        ...
        (this.opts = t({}, j, n || {}));
      var u = null;
      e && (u = "string" == typeof i ? w(i) : null != i ? i : window),
        (this.$el = u),
        u && this.bind(!0, !1);
    }
    return (
        ...
        if (e) {
          ...
          if (((u.opts = s), (u.cancel = !1), (u.hash = d), this.stop(), r)) {
            ...
            if (g)
              if (g.relative) {
                var E = C(r, f ? "y" : "x");
                (b.top = f ? E + g.top : g.top),
                  (b.left = f ? g.left : E + g.left);
              } else b = g;
            else if (i(n) && "#" !== n) {
              var I = w(n);
              if (!I) return;
            ...
            v && ((b.top += v.top), (b.left += v.left)),
              h && (b.top = Math.max(0, b.top - M(h).height));
            var S = (function (t) {
                var e = y(t) || x(t);
                return {
                  viewport: {
              ...
              L = S.size;
            (b.top = f
              ? Math.max(0, Math.min(L.height - A.height, b.top))
              : C(r, "y")),
              (b.left = p
                ? Math.max(0, Math.min(L.width - A.width, b.left))
                : C(r, "x")),
              !1 !== this.hook(s, "before", b, l)
                ? ((u.pos = b), this.start(s), this.bind(!1, !0))
                : (u.opts = null);
          }
        }
      }),
      ...
      (o.prototype.start = function (t) {
        ...
        (e.opts = t),
          (e.progress = !0),
          (e.easing = r(t.easing) ? t.easing : v[t.easing]);
        var n = this.$el,
          i = { top: C(n, "y"), left: C(n, "x") };
        ...
        if (t && u) {
          if (null != i && i !== window.location.hash) {
            ...
            e &&
              n &&
              !1 !== s &&
              window.history["replace" === s ? "replaceState" : "pushState"](
                null,
                "",
                i
              );
          ...
          this.unbind(!1, !0),
            (o.opts = null),
            (o.$trigger = null),
            r ? this.hook(u, "cancel") : this.hook(u, "after", a, l),
            this.hook(u, "complete", r);
        }
      }),
      (o.prototype.hook = function (t, e) {
        ...
        var u,
          ...
          l = t[e];
        return (
          r(l) && (u = l.apply(this, o.concat([this]))),
          (a = (n = this)["on" + (e[0].toUpperCase() + e.slice(1))].apply(
            n,
            o
          )),
          void 0 !== u ? u : a
      ...
      (o.prototype.bind = function (t, e) {
        var n = this.$el,
          o = this.ctx.opts;
        n &&
          (t && P(n, "click", this.handleClick, !1),
          e &&
            P(
              n,
      ...
      (o.prototype.unbind = function (t, e) {
        var n = this.$el,
          o = this.ctx.opts;
        n &&
          (t && Q(n, "click", this.handleClick, !1),
          e &&
            Q(
              n,
              "wheel touchstart touchmove",
